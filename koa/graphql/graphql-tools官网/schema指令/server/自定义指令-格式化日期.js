...
import { dateDirectiveTypeDefs, dateDirectiveTransformer } from './dateDirective'
// 连接 mongodb 数据库
...
const schema = makeExecutableSchema({
    typeDefs: [dateDirectiveTypeDefs,  `
        scalar Date
        type Query {
            today: Date @date(format: "YYYY年MM月DD日")
        }
    `],
    resolvers: {
        Query: {
...
// const typeDefs = [dateDirectiveTypeDefs, gql `
//     scalar Date
//     type Query {
//         today: Date @date(format: "YYYY-MM-DD")
//     }
// `]
